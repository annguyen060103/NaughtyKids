...
<head>
    ...
    <title>Giỏ Hàng - Naughtykids</title>
    <link rel="stylesheet"
            ...
            <div>
                <div class="content-desc">
                    <div class="content-desc-p1">
                        <div class="note">
                            <h5>Ghi chú của bạn là gì? Naughty đáp ứng hết nè!</h5>
                            <textarea rows="8" cols="40" name="note" id="note"
                                      placeholder="Ghi chú"></textarea>
                        </div>

                        <div class="sidebox">
                            <h5>Chính sách của Naughty</h5>
                            <ul>
                                <li><i class="fas fa-long-arrow-alt-right"></i>Các sản phẩm mua tại Naughty được áp dụng đổi size trong vòng 7 ngày (kể từ ngày quý khách nhận được hàng, căn cứ vào ngày gửi theo dấu bưu cục).
                                </li>
                                <li><i class="fas fa-long-arrow-alt-right"></i>Trong trường hợp sản phẩm hết size và Naughty hỗ trợ đổi qua sản phẩm khác, sản phẩm đổi phải có giá trị bằng hoặc cao hơn so với giá trị hàng khách đã nhận trước đó. Shop sẽ không hoàn trả lại số tiền chênh lệch.
                                </li>
                                <li><i class="fas fa-long-arrow-alt-right"></i>Sản phẩm chưa qua sử dụng (không bị dính bẩn) và còn đủ hộp (còn nguyên vẹn), phụ kiện đi kèm, đủ phiếu bảo hành, và hóa đơn (nếu có).
                                </li>
                                <li><i class="fas fa-long-arrow-alt-right"></i>Khách hàng đến trực tiếp cửa hàng để đổi size, nếu trường hợp ở xa gửi về khách hàng phải chịu phí ship 2 chiều.
                                </li>
                                <li><i class="fas fa-long-arrow-alt-right"></i>Các sản phẩm đều chỉ được đổi 1 lần duy nhất.
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="content-desc">
                    <div class="form-row">
                        ...
                        <c:if test="${isLogined }">
                            <div class="form-group">
                                <label for="customer_name">Họ và tên</label><br> <input
                                    ...
                                    name="customer_name" placeholder="Vui lòng nhập họ và tên của bạn" value="${userLogined.username }">
                            </div>
                            <div class="form-group">
                                <label for="customer_email">Địa chỉ email</label><br> <input
                                    type="email" class="form-control" id="customer_email"
                                    name="customer_email" placeholder="Vui lòng nhập địa chỉ email của bạn" value="${userLogined.email }">
                        <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                            </div>
                            <div class="form-group">
                                <label for="customer_phone">Số điện thoại</label><br> <input
                                    type="text" class="form-control" id="customer_phone"
                                    name="customer_phone" placeholder="Vui lòng nhập số điện thoại của bạn" value="${userLogined.phone}">
                            </div>
                            <div class="form-group">
                        ...
                        <c:if test="${!isLogined }">
                            <div class="form-group">
                                <label for="customer_name">Họ và tên</label><br> <input
                                    type="text" class="form-control" id="customer_name"
                                    name="customer_name" placeholder="Vui lòng nhập họ và tên của bạn" >

                            </div>
                            <div class="form-group">
                                <label for="customer_email">Địa chỉ email</label><br> <input
                                    type="email" class="form-control" id="customer_email"
                                    name="customer_email" placeholder="Vui lòng nhập địa chỉ email của bạn" >
                            </div>
                            <div class="form-group">
                                <label for="customer_phone">Số điện thoại</label><br> <input
                                    type="text" class="form-control" id="customer_phone"
                                    name="customer_phone" placeholder="Vui lòng nhập số điện thoại của bạn">
                            </div>
                            <div class="form-group">
                                <label for="customer_address">Địa chỉ</label><br> <input
                                    type="text" class="form-control" id="customer_address"
                    ...
                    <div class="content-desc-p2">
                        ...
                        <div class="p2-text">
                            <p>
                                Vui lòng kiểm tra kỹ thông tin đặt hàng của bạn.<br>Nếu xảy ra vấn đề liên quan đến đơn hàng hoặc sản phẩm, đừng vội đánh giá 1 sao mà hãy liên hệ với shop ngay nhé!
                            </p>
                        </div>
                        <div class="p2-action">
                            ...
                            <p>
                                <a href="${base }/collection"><i class="fas fa-undo"></i>Bạn muốn mua thêm? Nhấn vào đây!</a>
                            </p>
                        </div>
                    </div>
                </div>
