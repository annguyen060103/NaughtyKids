	...
	<main class="container">
		...
		<div class="content">
			...
			<div class="content-bar">
				<div class="title-bar">
					<div class="title-bar-p1">TÊN THƯƠNG HIỆU</div>
				...
				<div class="title-bar">
					<div class="title-bar-p1">MỨC GIÁ</div>
					<div class="filter-price">
						<ul class="checkbox-list">
							<li><input type="checkbox" id="p1" name="cc"
								data-price="(price:product<=1000000)"> <label for="p1">Dưới
									1.000.000 VND</label></li>
							<li><input type="checkbox" id="p2" name="cc"
								data-price="((price:product>)&amp;&amp;(price:product<=))">
								<label for="p2">0 VND - 0 VND</label></li>
							<li><input type="checkbox" id="p3" name="cc"
								data-price="((price:product>)&amp;&amp;(price:product<=))">
								<label for="p3">0 VND - 0 VND</label></li>
							<li><input type="checkbox" id="p4" name="cc"
								data-price="((price:product>)&amp;&amp;(price:product<=))">
								<label for="p4">0 VND - 0 VND</label></li>
							<li><input type="checkbox" id="p5" name="cc"
								data-price="(price:product>=1000000)"> <label for="p5">Trên
									1.000.000 VND</label></li>
						</ul>
					</div>
				</div>
